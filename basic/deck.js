...
class CardRenderer {
  ...
  createBackCardElement(variant = 1) {
    const cardNode = document.createElement("div");
...
deck.renderAll(table);

const renderer = new CardRenderer();
[1, 2, 3, 4].forEach((variant) => {
  table.appendChild(renderer.createBackCardElement(variant));
});

// Example summon call for other developers:
// deck.summon("A", "spades", table);
